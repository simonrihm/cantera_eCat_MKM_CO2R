...
-	“csv” (in Code ioManager::csv)
  - *Absolute (or relative) path to CSV file with which variables can be defined from an external source (for example within MoDS environment) -> see “var” and “phi”*
  - For VisualStudio version: path relative to project folder
  - For released version: path relative to folder with .exe
...
- “phi” (in Code simManager::potential)
  ...
  - lin(0,-2): Set potential to a function that changes value from in this case 0.0 to -2.0  linearly from time t=0s to t=t_end over nr. of steps  see “t_end” and “dt_max”
